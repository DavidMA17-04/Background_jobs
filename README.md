...
Al levantar los servicios, se puede acceder a las interfaces visuales en tiempo real desde el navegador:

- **Scheduler Dashboard:** [`http://localhost:3000/`](http://localhost:3000/) — Cuenta regresiva circular (10s), estado del Time Trigger y feed de tareas emitidas.
- **Worker Dashboard:** [`http://localhost:3001/`](http://localhost:3001/) — Indicador reactivo de estado (esperando/procesando) y tabla histórica de reportes generados.
